...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'hprinfra.com']
...
DATABASES = {
    'default': {
        ...
        'NAME': 'macosx',       # you must create this DB in phpMyAdmin
        'USER': 'root',
        'PASSWORD': 'admin123',
              # your MySQL password
        'HOST': '127.0.0.1',
        'PORT': '3308',                 # use correct port seen in phpMyAdmin or XAMPP
    }
}
...
EMAIL_HOST_USER = 'noreply@hprinfra.com'
EMAIL_HOST_PASSWORD = 'h+&}CaKj-5@f'
EMAIL_PORT = 25
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER
...
CSRF_TRUSTED_ORIGINS = ['https://hprinfra.com']

CORS_ALLOWED_ORIGINS = ['https://hprinfra.com']